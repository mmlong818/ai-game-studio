...
test('生成系统提示实际接入共享表现规则', () => {
  ...
  assert.match(source, /runtimeContract\(is3d,\s*project\.spec\.designProfile\.generatedCampaign,\s*renderableBlueprint\(project\.spec\.designProfile\.generatedBlueprint, project\.spec\.runtimeTarget\),/);
