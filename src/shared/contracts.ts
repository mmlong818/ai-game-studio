...
export const buildSchema = z.object({
  ...
  failureDetails: z.array(z.object({
    stage: z.enum(["planning", "design", "asset", "code", "validation", "browser", "delivery", "cancelled", "unknown"]),
    category: z.enum(["timeout", "network", "http", "authentication", "permission", "rate-limit", "invalid-response", "invalid-image", "validation", "configuration", "cancelled", "unknown"]),
