...
const llmAnswerSchema = z.object({
  ...
  three_mode: z.enum(["collector", "arena"]).nullable(),
...
const responseJsonSchema = {
  ...
  properties: {
    ...
    three_mode: { anyOf: [{ type: "string", enum: ["collector", "arena"] }, { type: "null" }], description: "仅 3d 时填写:有战斗/敌人/波次为 arena,其余收集探索为 collector;2d 时为 null" },
