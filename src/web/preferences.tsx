...
const zhTW: MessageTable = {
  ...
  "models.trigger": "模型", "models.title": "模型與金鑰", "models.description": "所有遊戲都必須生成並使用可追溯的 AI 點陣圖；未設定金鑰時會中斷構建，SVG 不會被接受。", "models.available": "可用模型", "models.keyLabel": "OpenAI API Key", "models.security": "金鑰只傳送到本機服務端，不寫入瀏覽器、資料庫、專案或遊戲產物；服務重啟後會清除。正式環境可使用 OPENAI_API_KEY。", "models.unconfigured": "尚未設定金鑰 · 無法構建遊戲", "models.session": "已設定 · 目前服務器工作階段", "models.environment": "已設定 · 服務器環境變數", "models.file": "已設定 · 本機金鑰檔案", "models.save": "儲存金鑰", "models.clear": "清除工作階段金鑰", "models.close": "關閉模型設定", "models.loadFailed": "無法讀取模型設定。", "models.saveFailed": "無法儲存金鑰。", "models.clearFailed": "無法清除金鑰。",
...
const en: MessageTable = {
  ...
  "models.trigger": "Models", "models.title": "Models & API Key", "models.description": "Every game must generate and use traceable AI bitmaps. Builds stop without a key, and SVG is rejected.", "models.available": "Available models", "models.keyLabel": "OpenAI API Key", "models.security": "The key is sent only to the local server. It is not written to the browser, database, project, or game output, and is cleared on restart. Use OPENAI_API_KEY in production.", "models.unconfigured": "API key not configured · builds unavailable", "models.session": "Configured · current server session", "models.environment": "Configured · server environment", "models.file": "Configured · local key file", "models.save": "Save key", "models.clear": "Clear session key", "models.close": "Close model settings", "models.loadFailed": "Could not load model settings.", "models.saveFailed": "Could not save the key.", "models.clearFailed": "Could not clear the key.",
