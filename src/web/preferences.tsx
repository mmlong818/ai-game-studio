...
const en: MessageTable = {
  ...
  "models.trigger": "Models", "models.title": "Models & API Key", "models.description": "Every game must generate and use traceable AI bitmaps. Builds stop without a key, and SVG is rejected.", "models.available": "Available models", "models.textRole": "Game design & code", "models.textDetail": "Plans gameplay, generates and revises code, and performs quality checks.", "models.imageRole": "Bitmap art & editing", "models.imageDetail": "Every build generates at least a cover and in-game background and records the model, role, and full prompt.", "models.keyLabel": "OpenAI API Key", "models.security": "The key is sent only to the local server. It is not written to the browser, database, project, or game output, and is cleared on restart. Use OPENAI_API_KEY in production.", "models.unconfigured": "API key not configured · builds unavailable", "models.session": "Configured · current server session", "models.environment": "Configured · server environment", "models.file": "Configured · local key file", "models.save": "Save key", "models.clear": "Clear session key", "models.close": "Close model settings", "models.loadFailed": "Could not load model settings.", "models.saveFailed": "Could not save the key.", "models.clearFailed": "Could not clear the key.",
  ...
  "library.searchPlaceholder": "Search games or gameplay…", "library.searchLabel": "Search games", "library.categories": "Filter by gameplay", "library.filterAll": "All", "library.noResults": "No matching games", "library.noResultsDetail": "Try another keyword, or clear the filters to see everything.", "library.clearFilters": "Clear filters", "library.template.signal-hunt": "Signal Hunt", "library.template.tetris": "Tetris", "library.template.puzzle": "Jigsaw Puzzle", "library.template.breakout": "Breakout", "library.template.klotski": "Klotski", "library.template.maze": "Maze", "library.template.snake": "Snake", "library.template.merge-2048": "2048 Merge", "library.template.space-shooter": "Space Shooter", "library.template.polyomino-fit": "Polyomino Fit", "library.template.block-place": "Block Place", "library.template.region-logic": "Region Logic", "library.template.mahjong-roguelite": "Mahjong Roguelite", "library.template.generated": "Free Creation",
