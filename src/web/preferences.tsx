...
const zhTW: MessageTable = {
  ...
  "a11y.skip": "跳到主要內容", "brand.home": "造界首頁", "nav.create": "創作", "nav.games": "遊戲大廳", "nav.local": "本機執行",
  "preferences.theme": "外觀", "preferences.language": "語言", "preferences.system": "跟隨系統", "preferences.light": "淺色", "preferences.dark": "深色",
  "models.trigger": "模型", "models.title": "模型與金鑰", "models.description": "平台固定使用一款創作模型和一款點陣圖模型，不提供其他模型選擇。", "models.available": "可用模型", "models.textRole": "遊戲設計與程式碼", "models.textDetail": "負責玩法規劃、程式碼生成、修改與品質檢查。", "models.imageRole": "點陣美術與編輯", "models.imageDetail": "負責封面、角色、場景、紋理和介面美術。", "models.keyLabel": "OpenAI API Key", "models.security": "金鑰只傳送到本機服務端，不寫入瀏覽器、資料庫、專案或遊戲產物；服務重啟後會清除。正式環境可使用 OPENAI_API_KEY。", "models.unconfigured": "尚未設定金鑰", "models.session": "已設定 · 目前服務器工作階段", "models.environment": "已設定 · 服務器環境變數", "models.file": "已設定 · 本機金鑰檔案", "models.save": "儲存金鑰", "models.clear": "清除工作階段金鑰", "models.close": "關閉模型設定", "models.loadFailed": "無法讀取模型設定。", "models.saveFailed": "無法儲存金鑰。", "models.clearFailed": "無法清除金鑰。",
...
const en: MessageTable = {
  ...
  "a11y.skip": "Skip to main content", "brand.home": "Forge home", "brand.name": "Forge", "nav.create": "Create", "nav.games": "Game Library", "nav.local": "Local",
  ...
  "models.trigger": "Models", "models.title": "Models & API Key", "models.description": "The platform uses one creation model and one bitmap model. No other model choices are exposed.", "models.available": "Available models", "models.textRole": "Game design & code", "models.textDetail": "Plans gameplay, generates and revises code, and performs quality checks.", "models.imageRole": "Bitmap art & editing", "models.imageDetail": "Creates covers, characters, environments, textures, and interface art.", "models.keyLabel": "OpenAI API Key", "models.security": "The key is sent only to the local server. It is not written to the browser, database, project, or game output, and is cleared on restart. Use OPENAI_API_KEY in production.", "models.unconfigured": "API key not configured", "models.session": "Configured · current server session", "models.environment": "Configured · server environment", "models.file": "Configured · local key file", "models.save": "Save key", "models.clear": "Clear session key", "models.close": "Close model settings", "models.loadFailed": "Could not load model settings.", "models.saveFailed": "Could not save the key.", "models.clearFailed": "Could not clear the key.",
...
const ja: MessageTable = {
  ...
  "a11y.skip": "メインコンテンツへ移動", "brand.home": "造界ホーム", "brand.name": "造界", "nav.create": "制作", "nav.games": "ゲーム一覧", "nav.local": "ローカル実行",
  "preferences.theme": "外観", "preferences.language": "言語", "preferences.system": "システムに従う", "preferences.light": "ライト", "preferences.dark": "ダーク",
  "models.trigger": "モデル", "models.title": "モデルと API キー", "models.description": "制作モデルとビットマップモデルを各1つに固定し、他のモデル選択は表示しません。", "models.available": "利用可能なモデル", "models.textRole": "ゲーム設計とコード", "models.textDetail": "ゲームプレイ設計、コード生成・修正、品質チェックを担当します。", "models.imageRole": "ビットマップアートと編集", "models.imageDetail": "カバー、キャラクター、背景、テクスチャ、UIアートを作成します。", "models.keyLabel": "OpenAI API Key", "models.security": "キーはローカルサーバーにのみ送信され、ブラウザー、DB、プロジェクト、ゲーム成果物には保存されません。サーバー再起動時に消去されます。本番環境では OPENAI_API_KEY を使用できます。", "models.unconfigured": "APIキー未設定", "models.session": "設定済み · 現在のサーバーセッション", "models.environment": "設定済み · サーバー環境変数", "models.file": "設定済み · ローカルキーファイル", "models.save": "キーを保存", "models.clear": "セッションキーを消去", "models.close": "モデル設定を閉じる", "models.loadFailed": "モデル設定を読み込めませんでした。", "models.saveFailed": "キーを保存できませんでした。", "models.clearFailed": "キーを消去できませんでした。",
